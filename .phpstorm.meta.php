...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./home/ikhsan/Development/laravel/zenkues/public/storage' => 'string',
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./home/ikhsan/Development/laravel/zenkues/public/storage','inertia.ssr.enabled',
...
'boost.browser-logs','sanctum.csrf-cookie','login',
'register','password.request','password.reset','auth.google','auth.google.callback',
'password.email','password.update','auth.register','auth.login','home',
'dashboard','dashboard.settings','profile','profile.update','dashboard.get_forms',
